...
function updateSlides() {
    ...
    const shouldResetSlideSize =
        params.slidesPerView === "auto" && params.breakpoints && Object.keys(params.breakpoints).filter((key) => typeof params.breakpoints[key].slidesPerView !== "undefined").length > 0;
            ...
            data.currentTranslate >
                (params.centeredSlides
                    ? swiper.minTranslate() -
                      ...
                      (params.slidesPerView !== "auto" && swiper.slides.length - params.slidesPerView >= 2 ? swiper.slidesSizesGrid[swiper.activeIndex + 1] + swiper.params.spaceBetween : 0) -
...
function initSliders() {
    if (document.querySelector(".services__slider"))
        new swiper_core_Swiper(".services__slider", {
            ...
            pagination: {
                el: ".services__nav .swiper-pagination",
                clickable: true,
                dynamicBullets: true,
            },
            navigation: {
    ...
    if (document.querySelector(".work__slider"))
        new swiper_core_Swiper(".work__slider", {
            modules: [Navigation, Pagination],
            observer: true,
            observeParents: true,
            slidesPerView: 1,
            ...
            loopAdditionalSlides: 3,
            pagination: {
                el: ".work__nav .swiper-pagination",
                clickable: true,
                dynamicBullets: true,
            },
            navigation: {
                prevEl: ".work__nav .swiper-button-prev",
                nextEl: ".work__nav .swiper-button-next",
            },
            breakpoints: {
                319: {
                    slidesPerView: 1.2,
